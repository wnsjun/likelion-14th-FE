        ...
        <div>
            ...
            <div className="mt-10">
                ...
                <FAQItem
                    ...
                    answer="A. 세션은 매주 목요일 오후 6시에 대면으로 진행됩니다.  공통 세션 이후, 각 파트별로 나누어 세션이 진행됩니다."
                />
                <FAQItem
            ...
            <div className="mt-10">
                ...
                <FAQItem
                    ...
                    answer="A. 디자인은 기디의 담당이지만, 기획은 다같이 우리의 서비스를 만들어가는 것을 목적으로 하고 있습니다. 개인이 기획을 진행할 수도 있고 팀원들과 협력해서 아이디어를 낼 수도 있습니다."
                />
                <FAQItem
